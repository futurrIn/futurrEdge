      ...
      <div className={styles.container}>
        ...
        <div className={styles.bottomBar}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <p>
              © {new Date().getFullYear()} <a href="https://www.futurredge.com" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text)', textDecoration: 'none', transition: 'color 0.2s' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--accent-cyan)'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--text)'}>Futurr Edge</a> is our web development & AI automation brand, built and maintained by <a href="https://futurr.in" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text)', textDecoration: 'none', transition: 'color 0.2s' }} onMouseOver={(e) => e.currentTarget.style.color = 'var(--accent-cyan)'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--text)'}>Futurr Innovations and Research</a>.
            </p>
          </div>
